...
public abstract class SelectiveClaimAugmentBlock extends ClaimAugmentBlock {
    ...
    protected boolean canApply(Claim claim, PlayerEntity player) {
        ...
        return  (mode == StatusEnum.TargetPlayer.EVERYONE || (mode == StatusEnum.TargetPlayer.TRUSTED && claim.hasPermission(player)));
    }
